...
本路径下包含基于昇思MindSpore的香橙派开发板离线推理应用案例，共分为两类：

| 分类     | 描述                           |
| :------ | :----------------------------- |
| [inference](./inference/) | 官方开发的离线推理案例，覆盖OCR、图像分类、图像增强、风格迁移、语义分割经典任务，及如机械臂分拣的趣味应用。 |
| [community](./community/) | 社区开发者贡献的离线推理，包含RingMoE遥感图像分类。|
